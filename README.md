...
AWS Certified Developer Associate 至 `Beginners Guide to EC2 / EC2 101`，另外已看章节 `S3` 到 `CORS Configuration Lab`，已完成章节 `Introduction to Serverless Computing`  
AWS Certified SysOps Administrator Associate 至 `Monitoring & Reporting / Metrics From Multiple Regions & Custom Dashboards`  
AWS Certified DevOps Engineer Professional 至 `SDLC Automation / What is CI/CD`
